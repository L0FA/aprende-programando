...
function AnimatedCategoryCard({ category, courseCount, compact }) {
    ...
    <div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link to="/categories" className="text-primary-500 hover:text-primary-600 dark:hover:text-primary-400 font-medium transition-colors flex items-center gap-1">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {categories.slice(0, 8).map((category, index) => (
            ...
            >
              <AnimatedCategoryCard category={category} courseCount={category.courseCount || category._count?.courses || 0} compact />
            </motion.div>
          ))}
        </div>
      </section>
